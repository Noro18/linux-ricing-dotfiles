...
To have VS Code and Cursor follow the wallpaper colorscheme:
1. Install the "Wallust" extension in both VS Code and Cursor
2. The extension will automatically use the colors generated by wallust at `~/.cache/wallust/colors.json`
3. No additional configuration is needed - the extension picks up the generated colors on wallpaper change

**Note**: Make sure the Wallust extension is installed in both editors for consistent theming across your development environment.