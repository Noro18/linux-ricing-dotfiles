...
hl.config({
	general = {
    gaps_in     = {top=8, right=0, bottom=0, left=0},
...
-- ── Animations ────────────────────────────────────────────────────────
  ...
  hl.curve( "overshoot", { type = "bezier", points = { { 0, 1.6}, {0.28, 1} } } ),
	...
	hl.animation({ leaf = "layers", enabled = true, speed = 5, bezier= "smooth", style="fade"}),
...
-- ── Layer Rules ───────────────────────────────────────────────────────
	...
	hl.animation({ leaf = "layers", enabled = true, speed = 6 , bezier = "MySmooth", style = "slide" })
